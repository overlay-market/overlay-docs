...
Overlay's core mechanic relies on OVL as the protocol's internal unit of account — when traders profit, OVL is minted to cover payouts; when traders lose, OVL is burned. While traders interact entirely in stablecoins, this mint/burn dynamic at the protocol level means the primary systemic risk Overlay faces is excessive inflation of OVL. This risk is managed through a range of mechanisms, detailed below.
...
### Overlay has undergone four comprehensive audits
Spearbit, Least Authority, Trail of Bits and Nethermind. For more details on Overlay's audits, read about them:
...
- [Nethermind Audit](https://github.com/overlay-market/v1-shiva/blob/main/audits/nethermind/audit.pdf).
